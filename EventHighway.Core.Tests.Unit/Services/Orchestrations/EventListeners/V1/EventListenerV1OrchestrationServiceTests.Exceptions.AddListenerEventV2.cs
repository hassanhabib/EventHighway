...
namespace EventHighway.Core.Tests.Unit.Services.Orchestrations.EventListeners.V1
{
    public partial class EventListenerV1OrchestrationServiceTests
    {
        ...
        public async Task ShouldThrowDependencyValidationOnAddListenerEventV1IfDependencyValidationErrorAndLogItAsync(
            Xeption listenerEventV1ValidationException)
        {
            ...
            ValueTask<ListenerEventV1> addListenerEventV1Task =
                this.eventListenerV1OrchestrationService.AddListenerEventV1Async(someListenerEventV1);
        ...
        public async Task ShouldThrowDependencyExceptionOnAddListenerEventV1IfDependencyErrorOccursAndLogItAsync(
        ...
        [Fact]
        public async Task ShouldThrowServiceExceptionOnAddListenerEventV1IfExceptionOccursAndLogItAsync()
        {
            // given
            ListenerEventV1 someListenerEventV1 = CreateRandomListenerEventV1();
            ...
            // when
            ValueTask<ListenerEventV1> addListenerEventV1Task =
                this.eventListenerV1OrchestrationService.AddListenerEventV1Async(
                    someListenerEventV1);
